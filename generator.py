...
ADDONS_ABSOLUTE_PATH = 'C:\\Users\\Admin\\Documents\\wizzard\\plugin'
...
GENERATE_ONLY_ADDONS = ['plugin.program.fcwizard']

# > Files and folders to be excluded per add-on, warning: does not take into account absolute paths of sub-folders
ZIP_EXCLUDED_FILES = {'plugin.program.fcwizard': ['tox.ini', 'changelog.txt', 'codecov.yml', 'Code_of_Conduct.md',
                                               'Contributing.md', 'Makefile', 'requirements.txt', 'README.md']}
ZIP_EXCLUDED_DIRS = {'plugin.program.fcwizard': ['tests', 'docs', '__pycache__', 'LICENSES', 'venv']}
